...
<?php endif; ?>
    <form class="form" method="POST" action="<?php echo e(route('updatedetail', ['id' => $job->id])); ?>">
    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xamppX64\htdocs\CustomerManagementSystem\resources\views/updatedetail.blade.php ENDPATH**/ ?>