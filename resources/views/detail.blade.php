...
@endif
    <form class="form" method="POST" action="{{ route('detail', ['id' => $job->id]) }}">
    @csrf
        ...
        <!--<div class="form__group">
            <input type="date" class="form__input" id="bastarih" name="bastarih" value="{{ $job->bastarih }}"/>
        </div>-->
        <div class="form__group">
        ...
        <div class="form__group">
        <button id="completeButton" class="btn" data-job-id="{{ $job->id }}" style="cursor:pointer; background:lightgreen; color:black;">İşi Bitir</button>
        </div>
    </form>
</div>
<script>
